...
% Camadas de abstrações Essas camadas exercem funções diferentes e são visíveis
...
% Importância de Compiladores No âmbito da computação em geral, compiladores são
...
% Calma aê, vamos começar lá de cima Porém, para compreender o conceito de
compilador é necessário estudar sobre linguagens de programação e o processo de
tradução.

\subsection{Linguagens}

% Linguagem é muito abstrato % CITAR COISA ABSTRATA SOBRE LINGUAGENS
...
% OK, lá vai... Linguagem Linguagem é um sistema de comunicação - um conjunto de
...
% Coisas interessantes sobre linguagem Dessa forma, pares que queiram interagir
...
% Linguagem de programação Partindo para o domínio computacional, há o conceito
...
% Programação -> Máquina Linguagens de programação são destinadas a expressar
...
% Linguagem de máquina É nesse conceito que se define a linguagem de máquina,
...
% Não é linguagem de programação Linguagem de máquina se diferencia das
...
% Finalmente, compiladores % CITAR CONCEITO DE COMPILADORES Compiladores são
